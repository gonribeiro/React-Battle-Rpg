...
export default function HowTo() {
    ...
    return (
        <div
            style={{ backgroundImage: "url(img/screens/background-landing.jpg)" }}
        >
            <Grid 
                container
                direction="row"
            ...
            >
                <Paper className="paper">
                    ...
                    <Typography className={classes.text}>
                        Battle Monster React é um jogo escrito em ReactJS de batalhas entre monstros por turnos. <br />
                    ...
                    <Grid container spacing={2}>
                        ...
                        <Grid container spacing={2} justify="center">
                            <Typography className={classes.title}><br /> Itens</Typography>
                        </Grid>
                        <Typography className={classes.text}>
